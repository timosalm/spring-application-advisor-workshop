...
(cd spring-petclinic-2.7 && git remote rename origin upstream && git remote add origin $GIT_PROTOCOL://$GIT_HOST/spring-petclinic && while ! git push origin main; do sleep 5; done)
