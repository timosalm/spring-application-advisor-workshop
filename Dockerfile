...
RUN --mount=type=secret,id=app_advisor_commercial_recipes_version \
  mvn dependency:get -DrepoUrl=https://packages.broadcom.com/artifactory/spring-enterprise -Dartifact=com.vmware.tanzu.spring.recipes:spring-boot-3-upgrade-recipes:1.0.0
